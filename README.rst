...
A Python library and CLI tool for scraping YouTube channels for live and
...
+---------------------------+--------------+------------------------------------+
| ``thumbnail_url``         | ``str``      | URL of the stream’s thumbnail      |
|                           |              | image                              |
+---------------------------+--------------+------------------------------------+
| ``live``                  | ``bool``     | ``True`` if the stream is          |
|                           |              | currently live                     |
+---------------------------+--------------+------------------------------------+
